...
;(test 2.0 (denominator (exact->inexact (/ 6 4))))
...
(test 1.0 (exact->inexact (exp 0))) ;; may return exact number
(test~= 20.0855369231877 (exp 3))

(test 0.0 (exact->inexact (log 1))) ;; may return exact number
(test 1.0 (log (exp 1)))
(test 42.0 (log (exp 42)))
;(test 2.0 (log 100 10)) 
;(test 12.0 (log 4096 2))

(test 0.0 (exact->inexact (sin 0))) ;; may return exact number
(test 1.0 (sin 1.5707963267949))
(test 1.0 (exact->inexact (cos 0))) ;; may return exact number
(test -1.0 (cos 3.14159265358979))
(test 0.0 (exact->inexact (tan 0))) ;; may return exact number
(test~= 1.5574077246549 (tan 1))

(test 0.0 (exact->inexact (asin 0))) ;; may return exact number
(test~= 1.5707963267949 (asin 1))
(test 0.0 (exact->inexact (acos 1))) ;; may return exact number
...
(test 3.0 (exact->inexact (sqrt 9)))
(test~= 1.4142135623731 (sqrt 2))
;(test 0.0+1.0i (exact->inexact (sqrt -1)))
...
(test #t (inexact? (exact->inexact 1)))
(test 1 (inexact->exact 1.0))
(test #t (exact? (inexact->exact 1.0)))
...
;;libm:no support by design;;(test-numeric-syntax "#x1e2" 482 "482")
