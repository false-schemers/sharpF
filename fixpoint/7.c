...
static obj cx__231529; /* constant #1529 */
static obj cx__231534; /* constant #1534 */
static obj cx__231552; /* constant #1552 */
static obj cx__231768; /* constant #1768 */
static obj cx__232051; /* constant #2051 */
static obj cx__232052; /* constant #2052 */
static obj cx__232055; /* constant #2055 */
static obj cx__232058; /* constant #2058 */
static obj cx__232061; /* constant #2061 */
static obj cx__232064; /* constant #2064 */
static obj cx__232067; /* constant #2067 */
static obj cx__232079; /* constant #2079 */
static obj cx__232082; /* constant #2082 */
static obj cx__232085; /* constant #2085 */
static obj cx__232088; /* constant #2088 */
static obj cx__232109; /* constant #2109 */
static obj cx__232112; /* constant #2112 */
static obj cx__232119; /* constant #2119 */
static obj cx__232129; /* constant #2129 */
static obj cx__232132; /* constant #2132 */
static obj cx__232196; /* constant #2196 */
static obj cx__232202; /* constant #2202 */
static obj cx__232205; /* constant #2205 */
static obj cx__232208; /* constant #2208 */
static obj cx__232500; /* constant #2500 */
static obj cx__232507; /* constant #2507 */
static obj cx__232516; /* constant #2516 */
static obj cx__232522; /* constant #2522 */
static obj cx__232536; /* constant #2536 */
static obj cx__232562; /* constant #2562 */
static obj cx__232583; /* constant #2583 */
static obj cx__232588; /* constant #2588 */
static obj cx__232593; /* constant #2593 */
static obj cx__232596; /* constant #2596 */
static obj cx__232864; /* constant #2864 */
...
static obj cx__232958; /* constant #2958 */
static obj cx__232974; /* constant #2974 */
static obj cx__233018; /* constant #3018 */
static obj cx__233027; /* constant #3027 */
static obj cx__233037; /* constant #3037 */
static obj cx__233038; /* constant #3038 */
static obj cx__233046; /* constant #3046 */
static obj cx__233051; /* constant #3051 */
static obj cx__233060; /* constant #3060 */
static obj cx__233073; /* constant #3073 */
static obj cx__233074; /* constant #3074 */
static obj cx__233077; /* constant #3077 */
static obj cx__233085; /* constant #3085 */
static obj cx__233184; /* constant #3184 */
static obj cx__233185; /* constant #3185 */
static obj cx__233207; /* constant #3207 */
static obj cx__233221; /* constant #3221 */
static obj cx__233231; /* constant #3231 */
static obj cx__233232; /* constant #3232 */
static obj cx__233270; /* constant #3270 */
...
static obj cx_halt_2Dexp_3F_231933; /* constant halt-exp?#1933 */
...
{ 
  ...
  { /* let */
    ...
    v3616_tmp = obj_from_fixnum(n); };
    { /* length */
    int n; obj l = (vectorref((v337_rator), (1)));
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v3615_tmp = obj_from_fixnum(n); };
    return obj_from_bool(fixnum_from_obj(v3615_tmp) == fixnum_from_obj(v3616_tmp));
  }
  } else {
    return obj_from_bool(0);
  }
...
/* label-id?#1553 */
static obj cxs_label_2Did_3F_231553(obj v1555_id)
{ 
    return ((!(fixnum_from_obj(car((cdr((cdr((v1555_id))))))) < (0))) ? obj_from_bool((car((cdr((cdr((cdr((v1555_id))))))))) == obj_from_bool(1)) : obj_from_bool(0));
}

/* degenerate-let-exp->body#2366 */
static obj cxs_degenerate_2Dlet_2Dexp_2D_3Ebody_232366(obj v2368_exp)
{ 
    return ((isnull((vectorref((v2368_exp), (2))))) ? (vectorref((vectorref((v2368_exp), (1))), (2))) : (car((vectorref((v2368_exp), (2))))));
}

/* null-let-exp?#2392 */
static obj cxs_null_2Dlet_2Dexp_3F_232392(obj v2394_exp)
{ 
  if (bool_from_obj((isvector((v2394_exp))) ? (((vectorlen((v2394_exp))) == (3)) ? obj_from_bool((vectorref((v2394_exp), (0))) == (mksymbol(internsym("app-exp")))) : obj_from_bool(0)) : obj_from_bool(0))) {
  if ((isnull((vectorref((v2394_exp), (2)))))) {
  { /* let */
    obj v2398_rator = (vectorref((v2394_exp), (1)));
    return (bool_from_obj((isvector((v2398_rator))) ? (((vectorlen((v2398_rator))) == (3)) ? obj_from_bool((vectorref((v2398_rator), (0))) == (mksymbol(internsym("lambda-exp")))) : obj_from_bool(0)) : obj_from_bool(0)) ? obj_from_bool(isnull((vectorref((v2398_rator), (1))))) : obj_from_bool(0));
  }
  } else {
    return obj_from_bool(0);
  }
...
/* identity-lambda-exp?#2438 */
static obj cxs_identity_2Dlambda_2Dexp_3F_232438(obj v2440_exp)
{ 
  if (bool_from_obj((isvector((v2440_exp))) ? (((vectorlen((v2440_exp))) == (3)) ? obj_from_bool((vectorref((v2440_exp), (0))) == (mksymbol(internsym("lambda-exp")))) : obj_from_bool(0)) : obj_from_bool(0))) {
  { /* let */
    obj v2447_body = (vectorref((v2440_exp), (2)));
    obj v2448_ids = (vectorref((v2440_exp), (1)));
    return ((ispair((v2448_ids))) ? ((isnull((cdr((v2448_ids))))) ? (bool_from_obj((isvector((v2447_body))) ? (((vectorlen((v2447_body))) == (2)) ? obj_from_bool((vectorref((v2447_body), (0))) == (mksymbol(internsym("var-exp")))) : obj_from_bool(0)) : obj_from_bool(0)) ? obj_from_bool((car((v2448_ids))) == (vectorref((v2447_body), (1)))) : obj_from_bool(0)) : obj_from_bool(0)) : obj_from_bool(0));
  }
  } else {
    return obj_from_bool(0);
  }
...
/* identity-let-exp?#2425 */
static obj cxs_identity_2Dlet_2Dexp_3F_232425(obj v2427_exp)
{ 
  if (bool_from_obj((isvector((v2427_exp))) ? (((vectorlen((v2427_exp))) == (3)) ? obj_from_bool((vectorref((v2427_exp), (0))) == (mksymbol(internsym("app-exp")))) : obj_from_bool(0)) : obj_from_bool(0))) {
  if (bool_from_obj(cxs_identity_2Dlambda_2Dexp_3F_232438((vectorref((v2427_exp), (1)))))) {
  { /* let */
    obj v2431_rands = (vectorref((v2427_exp), (2)));
    return ((ispair((v2431_rands))) ? obj_from_bool(isnull((cdr((v2431_rands))))) : obj_from_bool(0));
  }
  } else {
    return obj_from_bool(0);
  }
...
/* degenerate-let-exp?#2389 */
static obj cxs_degenerate_2Dlet_2Dexp_3F_232389(obj v2391_exp)
{ 
  { /* let */
    obj v2424_x = (cxs_null_2Dlet_2Dexp_3F_232392((v2391_exp)));
    return (bool_from_obj(v2424_x) ? (v2424_x) : (cxs_identity_2Dlet_2Dexp_3F_232425((v2391_exp))));
  }
}

/* cvar-id?#2937 */
static obj cxs_cvar_2Did_3F_232937(obj v2939_id)
{ 
    return ((!(fixnum_from_obj(car((cdr((cdr((v2939_id))))))) < (0))) ? obj_from_bool(isstring((car((cdr((cdr((cdr((v2939_id))))))))))) : obj_from_bool(0));
}
...
{ 
  ...
  { /* letrec */
    ...
    obj v31_tl;
  { /* let */
    obj v3612_tmp = (cdr((v28_lst)));
    obj v3611_tmp = (v28_lst);
    /* tail call */
    v32_hd = (v3611_tmp);
    v31_tl = (v3612_tmp);
    goto s_loop;
  ...
  { /* let */
    obj v3610_tmp = (cdr((cdr((v31_tl)))));
    obj v3609_tmp = (cdr((v32_hd)));
    /* tail call */
    v32_hd = (v3609_tmp);
    v31_tl = (v3610_tmp);
    goto s_loop;
...
case 0: /* load module */
    ...
    cx__231513 = (hpushstr(0, newstring(s))); }
    cx__231520 = (hpushstr(0, newstring("bool")));
    { static char s[] = { 40, 98, 111, 111, 108, 95, 102, 114, 111, 109, 95, 36, 97, 114, 103, 32, 38, 38, 32, 0 };
    cx__231529 = (hpushstr(0, newstring(s))); }
    cx__231534 = (hpushstr(0, newstring("bool(0)")));
    cx__231552 = (hpushstr(0, newstring("escaping label???")));
    { /* cons */ 
    ...
    *--hp = obj_from_size(PAIR_BTAG); 
    ...
    cx__232058 = (hpushstr(0, newstring(s))); }
    ...
    cx__232061 = (hpushstr(0, newstring(s))); }
    ...
    cx__232082 = (hpushstr(0, newstring(s))); }
    ...
    cx__232085 = (hpushstr(0, newstring(s))); }
    { static char s[] = { 114, 91, 48, 93, 32, 61, 32, 111, 98, 106, 95, 102, 114, 111, 109, 95, 36, 97, 114, 103, 59, 10, 0 };
    cx__232088 = (hpushstr(0, newstring(s))); }
    cx__232109 = (hpushstr(0, newstring(";")));
    cx__232112 = (hpushstr(0, newstring("    goto ")));
    ...
    cx__232208 = (hpushstr(0, newstring(s))); }
    cx__232500 = (hpushstr(0, newstring("}")));
    cx__232507 = (hpushstr(0, newstring("} else {")));
    cx__232516 = (hpushstr(0, newstring("])) {")));
    cx__232522 = (hpushstr(0, newstring("if (bool_from_obj(r[")));
    { static char s[] = { 105, 102, 32, 40, 98, 111, 111, 108, 95, 102, 114, 111, 109, 95, 36, 97, 114, 103, 41, 32, 123, 0 };
    cx__232536 = (hpushstr(0, newstring(s))); }
    cx__232562 = (hpushstr(0, newstring("void(0)")));
    cx__232583 = (hpushstr(0, newstring(" = (obj)c; }")));
    cx__232588 = (hpushstr(0, newstring(") }; ")));
    cx__232593 = (hpushstr(0, newstring("static obj c[] = { obj_from_case(")));
    cx__232596 = (hpushstr(0, newstring("{ ")));
    cx__232864 = (hpushstr(0, newstring(" }")));
    cx__232881 = (hpushstr(0, newstring("_t ")));
    cx__232895 = (hpushstr(0, newstring(" } ")));
    cx__232916 = (hpushstr(0, newstring("{ const ")));
    cx__232921 = (hpushstr(0, newstring(" = ")));
    cx__232950 = (hpushstr(0, newstring("")));
    cx__232958 = (hpushstr(0, newstring("_")));
    cx__232974 = (hpushstr(0, newstring("v")));
    cx__233018 = (hpushstr(0, newstring("invalid lval cg target")));
    { static char s[] = { 114, 91, 36, 97, 93, 32, 61, 32, 111, 98, 106, 95, 102, 114, 111, 109, 95, 0 };
    cx__233027 = (hpushstr(0, newstring(s))); }
    { static char s[] = { 36, 97, 32, 61, 32, 36, 97, 95, 102, 114, 111, 109, 95, 0 };
    cx__233037 = (hpushstr(0, newstring(s))); }
    cx__233038 = (hpushstr(0, newstring(" = obj_from_")));
    cx__233046 = (hpushstr(0, newstring("void_from_")));
    cx__233051 = (hpushstr(0, newstring("invalid rval cg target")));
    { static char s[] = { 111, 98, 106, 40, 114, 91, 36, 97, 93, 41, 0 };
    cx__233060 = (hpushstr(0, newstring(s))); }
    { static char s[] = { 36, 97, 40, 36, 97, 44, 32, 36, 97, 41, 0 };
    cx__233073 = (hpushstr(0, newstring(s))); }
    cx__233074 = (hpushstr(0, newstring(")")));
    cx__233077 = (hpushstr(0, newstring("obj(")));
    cx__233085 = (hpushstr(0, newstring("void")));
    cx__233184 = (hpushstr(0, newstring("a")));
    cx__233185 = (hpushstr(0, newstring("z")));
    cx__233207 = (hpushstr(0, newstring("/* live regs: ")));
    cx__233221 = (hpushstr(0, newstring(".")));
    { static char s[] = { 10, 32, 32, 0 };
    cx__233231 = (hpushstr(0, newstring(s))); }
    { static char s[] = { 10, 32, 32, 32, 32, 0 };
    cx__233232 = (hpushstr(0, newstring(s))); }
    cx__233270 = (hpushstr(0, newstring("#define MAX_LIVEREGS ")));
...
case 13: /* halt-exp?#1933 k exp */
    assert(rc == 3);
    r += 1; /* shift reg. wnd */
gs_halt_2Dexp_3F_231933: /* k exp */
  if ((isvector((r[1])))) {
  if (((vectorlen((r[1]))) == (4))) {
    r[2] = (vectorref((r[1]), (0)));
...
case 42: /* clo k id renv */
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7832_tmp = (n); }
    r[4] = obj_from_fixnum((1) + (v7832_tmp)); }
...
case 44: /* clo k id ids rands */
  ...
  if (bool_from_obj(r[5])) {
    ...
    *--hp = obj_from_case(45);
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7829_tmp = (n); }
    v7831_tmp = ((v7830_tmp) == (v7829_tmp)); } }
    r[7] = obj_from_bool(!(v7831_tmp)); }
...
case 45: /* clo ek  */
    ...
    r[1+6] = p[5]; }
    r += 1; /* shift reg. wnd */
s_l_v7495: /* ek  id ids k tmp rands */
    { bool_t v7828_tmp;
    { fixnum_t v7827_tmp;
    { fixnum_t v7826_tmp;
    { /* length */
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7826_tmp = (n); }
    v7828_tmp = ((v7827_tmp) == (v7826_tmp)); } }
    r[7] = obj_from_bool(!(v7828_tmp)); }
  if (bool_from_obj(r[7])) {
    { /* cons */ 
    hreserve(hbsz(3), 7); /* 7 live regs */
    *--hp = (mknull());
...
case 50: /* clo ek r */
    ...
    /* ek r r k */
    { /* string-append */
    int *d = stringcat(stringdata((r[1])), stringdata((cx__232958)));
    r[4] = (hpushstr(4, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232974)), stringdata((r[4])));
    r[5] = (hpushstr(5, d)); }
    r[0] = (cx_c_2Dmangle);
    pc = objptr_from_obj(r[0])[0];
    r[1] = r[3];  
...
case 52: /* clo k tgt */
  ...
  if (bool_from_obj(cxs_cvar_2Did_3F_232937((r[4])))) {
    hreserve(hbsz(3+1), 6); /* 6 live regs */
    *--hp = r[5];  
    *--hp = r[4];  
    *--hp = r[0];  
...
case 53: /* clo ek r */
    ...
    /* ek r k */
    { /* string-append */
    int *d = stringcat(stringdata((r[1])), stringdata((cx__233074)));
    r[3] = (hpushstr(3, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__233077)), stringdata((r[3])));
    r[4] = (hpushstr(4, d)); }
    r[0] = r[2];  
    pc = objptr_from_obj(r[0])[0];
    r[1] = obj_from_ktrap();
...
case 57: /* clo ek r */
    ...
    /* ek r k */
    { /* string-append */
    int *d = stringcat(stringdata((r[1])), stringdata((cx__233038)));
    r[3] = (hpushstr(3, d)); }
    r[4+0] = r[2];  
    pc = objptr_from_obj(r[4+0])[0];
    r[4+1] = obj_from_ktrap();
...
case 60: /* clo k renv rands */
    ...
    v7825_tmp = (n); }
    { /* reverse */
    obj l, o = mknull(); int c = (v7825_tmp);
    hreserve(hbsz(3)*c, 3); /* 3 live regs */
    l = r[1];   /* gc-safe */
...
case 61: /* clo k rands regs spoiled */
    assert(rc == 5);
    r += 1; /* shift reg. wnd */
s_loop_v7261: /* k rands regs spoiled */
  if ((isnull((r[1])))) {
    /* r[0] */    
    pc = objptr_from_obj(r[0])[0];
    r[1] = obj_from_ktrap();
...
case 62: /* clo ek r */
    ...
    r[1+6] = p[5]; }
    r += 1; /* shift reg. wnd */
s_l_v7382: /* ek r loop spoiled regs rands k */
  if (bool_from_obj(r[1])) {
    r[7] = (car((r[4])));
    { /* cons */ 
    hreserve(hbsz(3), 8); /* 8 live regs */
...
case 92: /* clo k id */
    ...
    r[1+2] = p[1]; }
    r += 1; /* shift reg. wnd */
s_loop_v7172: /* k id cg-gcsafe-cexp? */
  if ((isnull((r[1])))) {
    r[3+0] = r[0];  
    pc = objptr_from_obj(r[3+0])[0];
    r[3+1] = obj_from_ktrap();
...
case 97: /* clo k id */
    ...
    r[1+2] = p[1]; }
    r += 1; /* shift reg. wnd */
s_loop_v7149: /* k id cg-gcsafe-cexp? */
  if ((isnull((r[1])))) {
    r[3+0] = r[0];  
    pc = objptr_from_obj(r[3+0])[0];
    r[3+1] = obj_from_ktrap();
...
case 115: /* clo ek r */
    ...
    r[1+7] = p[6]; }
    r += 1; /* shift reg. wnd */
s_l_v7016: /* ek r cg-complex-to cg-application-to renv exp tgt k */
  if (bool_from_obj(r[1])) {
    r[0] = r[3];  
    pc = objptr_from_obj(r[0])[0];
    r[1] = r[7];  
...
s_cg_2Dcexp: /* k exp renv cg-tgt-rval */
  ...
  if (bool_from_obj(r[5])) {
    ...
    *--hp = obj_from_case(125);
    r[6] = (hendblk(4+1));
  if (bool_from_obj(cxs_label_2Did_3F_231553((r[5])))) {
    { /* cons */ 
    hreserve(hbsz(3), 7); /* 7 live regs */
    *--hp = (mknull());
    *--hp = r[5];  
...
case 125: /* clo ek  */
    ...
    r[1+5] = p[4]; }
    r += 1; /* shift reg. wnd */
s_l_v6902: /* ek  cg-tgt-rval renv id k */
    { /* cons */ 
    hreserve(hbsz(3), 6); /* 6 live regs */
    *--hp = r[3];  
    *--hp = r[4];  
...
case 130: /* clo ek r */
    ...
    r += 1; /* shift reg. wnd */
    /* ek r r r k r r */
    r[7] = ((bool_from_obj(r[1]) && (bool_from_obj(r[6]) && (strcmp(stringchars((r[1])), stringchars((r[6]))) == 0))) ? (r[1]) : (cx__231484));
  if (((strcmp(stringchars((r[7])), stringchars((cx__231520))) == 0) && (strcmp(stringchars((r[5])), stringchars((cx__231534))) == 0))) {
    { /* string-append */
    int *d = stringcat(stringdata((r[7])), stringdata((cx__231494)));
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__231529)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
  ...
  if (((strcmp(stringchars((r[7])), stringchars((cx__231520))) == 0) && (strcmp(stringchars((r[2])), stringchars((r[3]))) == 0))) {
    { /* string-append */
    int *d = stringcat(stringdata((r[7])), stringdata((cx__231494)));
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__231513)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((r[7])), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    ...
    *--hp = obj_from_size(PAIR_BTAG); 
    ...
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__231497)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((r[7])), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
...
s_loop_v6854: /* k id cg-cexp renv */
  if ((isnull((r[1])))) {
    /* r[0] */    
    pc = objptr_from_obj(r[0])[0];
    r[1] = obj_from_ktrap();
...
case 140: /* clo ek r */
    ...
    /* ek r cg-primapp-to renv rands tgt k */
    { /* string-append */
    int *d = stringcat(stringdata((cx__23780)), stringdata((cx__232196)));
    r[7] = (hpushstr(7, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((r[1])), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232202)), stringdata((r[7])));
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232205)), stringdata((r[8])));
    r[9] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232208)), stringdata((r[9])));
    r[10] = (hpushstr(10, d)); }
    { fixnum_t v7822_tmp;
    { /* length */
    int n; obj l = r[4];  
    ...
    v7822_tmp = (n); }
    { /* reverse */
    obj l, o = mknull(); int c = (v7822_tmp);
...
case 143: /* clo ek r */
    ...
    /* ek r cg-primapp-to renv rands tgt k */
    { /* string-append */
    int *d = stringcat(stringdata((r[1])), stringdata((cx__232109)));
    r[7] = (hpushstr(7, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232129)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232132)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* vector */
    hreserve(hbsz(4+1), 8); /* 8 live regs */
    *--hp = r[4];  
...
case 144: /* clo ek r */
    ...
    r[7] = (hpushstr(7, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232112)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232055)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232058)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232119)), stringdata((r[7])));
    r[7] = (hpushstr(8, d)); }
    { /* vector */
    hreserve(hbsz(4+1), 8); /* 8 live regs */
    *--hp = r[4];  
...
case 148: /* clo ek r */
  ...
  if (bool_from_obj(r[1])) {
    { /* string-append */
    int *d = stringcat(stringdata((cx__232052)), stringdata((cx__232051)));
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232079)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232082)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232085)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232088)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* cons */ 
    hreserve(hbsz(3), 9); /* 9 live regs */
    *--hp = r[4];  
    ...
    *--hp = obj_from_size(VECTOR_BTAG);
    ...
    r[8] = (hpushstr(8, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232055)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232058)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232061)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232064)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((cx__232067)), stringdata((r[8])));
    r[8] = (hpushstr(9, d)); }
    { /* cons */ 
    hreserve(hbsz(3), 9); /* 9 live regs */
    *--hp = r[4];  
...
s_cg_2Dprimapp_2Dto: /* k tgt exp renv cg-cexp? gvar-id->c-name cvar-id->c-name make-gclabel global-constant-labels cg-fast-goto? lookup-label lookup-curry-case-no max-live cg-tgt-lval nl/regs-comment cg-gcsafe-cexp? alloc-reg cg-tgt-rval */
  ...
  if (bool_from_obj(r[18])) {
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7820_tmp = (n); }
    r[20] = obj_from_fixnum((v7821_tmp) + (v7820_tmp)); } }
...
case 153: /* clo k code args new-renv */
    assert(rc == 5);
    { obj* p = objptr_from_obj(r[0]);
    r[1+4] = p[1];
    r[1+5] = p[2];
...
case 164: /* clo ek r */
  ...
  if (bool_from_obj(cxs_degenerate_2Dlet_2Dexp_3F_232389((r[13])))) {
    r[0] = r[7];  
    pc = objptr_from_obj(r[0])[0];
    r[1] = (r[12]);
    r[2] = r[8];  
    r[3] = (cxs_degenerate_2Dlet_2Dexp_2D_3Ebody_232366((r[13])));
    r[4] = (r[11]);
    rreserve(MAX_LIVEREGS);
    assert(rc = 5);
    goto jump;
...
case 191: /* clo k exps vars renv cont */
    assert(rc == 6);
    { obj* p = objptr_from_obj(r[0]);
    r[1+5] = p[1];
    r[1+6] = p[2];
  ...
  if ((isnull((r[1])))) {
    ...
    r[21] = (car((r[2])));
    r[21] = (cxs_cvar_2Did_3F_232937((r[21])));
...
case 194: /* clo ek r */
    ...
    r[1+10] = p[9]; }
    r += 1; /* shift reg. wnd */
s_l_v6351: /* ek r cvar-id->c-name cg-let-list cont renv vars exps k id r */
  if (bool_from_obj(r[1])) {
    hreserve(hbsz(3+1), 11); /* 11 live regs */
    *--hp = (r[10]);
    *--hp = r[9];  
...
case 199: /* clo ek r */
  ...
  if (bool_from_obj(r[5])) {
    ...
    r[5] = (car((r[5])));
    { /* string-append */
    int *d = stringcat(stringdata((r[2])), stringdata((cx__232921)));
    r[6] = (hpushstr(6, d)); }
    r[7+0] = (cx_string_2Dstarts_2Dwith_3F);
    pc = objptr_from_obj(r[7+0])[0];
    r[7+1] = r[3];  
    r[7+2] = r[5];  
    r[7+3] = r[6];  
...
case 208: /* clo k code atexts renv */
    assert(rc == 5);
    { obj* p = objptr_from_obj(r[0]);
    r[1+4] = p[1];
    r[1+5] = p[2];
...
case 212: /* clo k code atexts renv */
    assert(rc == 5);
    { obj* p = objptr_from_obj(r[0]);
    r[1+4] = p[1];
    r[1+5] = p[2];
...
case 215: /* clo ek r */
    ...
    r[4] = (hpushstr(5, d)); }
    { /* string-append */
    int *d = stringcat(stringdata((bool_from_obj(cxs_global_2Did_2Dprivate_2Dconstant_3F_23618((r[3]))) ? (cx__233185) : (cx__233184))), stringdata((r[4])));
    r[5] = (hpushstr(5, d)); }
    r[0] = r[2];  
    pc = objptr_from_obj(r[0])[0];
    r[1] = obj_from_ktrap();
...
s_loop_v5982: /* k ids lams code make-gclabel used-global-labels lookup-label used-labels code-gen-to-nextreg global-labels curry-alist global-constant-labels r */
  if ((isnull((r[1])))) {
    ...
    v7818_tmp = (n); }
    { /* reverse */
    obj l, o = mknull(); int c = (v7818_tmp);
...
s_l_v5998: /* ek r code-gen-to-nextreg lam global-labels id curry-alist loop code lams ids k */
    ...
    *--hp = obj_from_case(234);
    ...
    v7817_tmp = (n); }
    { /* reverse */
    obj l, o = mknull(); int c = (v7817_tmp);
...
s_loop_v6009: /* k alst i global-labels id */
  ...
  if (bool_from_obj(r[5])) {
    ...
    *--hp = obj_from_void(0);
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7816_tmp = (n); }
    r[11] = obj_from_fixnum((v7816_tmp) + (1)); }
...
s_l_v6042: /* ek r k i id global-labels id&ids&rands */
    ...
    *--hp = obj_from_size(PAIR_BTAG); 
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7815_tmp = (n); }
    r[9] = obj_from_fixnum((1) + (v7815_tmp)); }
    { /* cons */ 
    hreserve(hbsz(3), 10); /* 10 live regs */
    *--hp = r[8];  
    *--hp = r[9];  
...
s_l_v5894: /* ek r input-fix-exp global-vars k max-live r r curry-alist */
    ...
    *--hp = obj_from_void(0);
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7814_tmp = (n); }
    r[10] = obj_from_fixnum((1) + (v7814_tmp)); }
...
s_loop_v5918: /* k i code ncases */
    { const fixnum_t v7812_i = fixnum_from_obj(r[1]);
    r[4] = (objptr_from_obj(r[3])[0]);
    r[4] = obj_from_bool((v7812_i) == fixnum_from_obj(r[4]));
  if (bool_from_obj(r[4])) {
    { fixnum_t v7813_tmp;
    { /* length */
    int n; obj l = r[2];  
...
case 284: /* clo ek  */
  ...
  if (bool_from_obj(r[7])) {
    ...
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v7808_tmp = (n); }
    v7810_tmp = ((v7809_tmp) == (v7808_tmp)); } }
    r[9] = obj_from_bool(!(v7810_tmp)); }
  if (bool_from_obj(r[9])) {
    { /* cons */ 
    hreserve(hbsz(3), 9); /* 9 live regs */
    *--hp = (mknull());
