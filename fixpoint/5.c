...
static obj cx_curry_2Dexp_231422; /* constant curry-exp#1422 */
static obj cx_intersectionq_231496; /* constant intersectionq#1496 */
static obj cx_setdiffq_231479; /* constant setdiffq#1479 */
static obj cx_unionq_231461; /* constant unionq#1461 */
...
{ 
  ...
  { /* let */
    ...
    v2101_tmp = obj_from_fixnum(n); };
    { /* length */
    int n; obj l = (vectorref((v147_rator), (+1)));
    for (n = 0; l != mknull(); ++n, l = cdr(l)) ;
    v2100_tmp = obj_from_fixnum(n); };
    return obj_from_bool(fixnum_from_obj(v2100_tmp) == fixnum_from_obj(v2101_tmp));
  }
  } else {
...
/* subsetq?#1598 */
static obj cxs_subsetq_3F_231598(obj v1601_s1, obj v1600_s2)
{ 
  { /* letrec */
    obj v1603_id;
    /* tail call */
  ...
  s_loop:
  if ((isnull((v1603_id)))) {
    return obj_from_bool(isnull((v1603_id)));
  } else {
  { /* let */
    obj v2098_tmp;
    { /* memq */
    obj x = (car((v1603_id))), l = (v1600_s2);
    for (; l != mknull(); l = cdr(l)) if (car(l) == x) break;
    v2098_tmp = (l == mknull() ? obj_from_bool(0) : l); };
  if (bool_from_obj(v2098_tmp)) {
  { /* let */
    obj v2099_tmp = (cdr((v1603_id)));
    /* tail call */
    v1603_id = (v2099_tmp);
    goto s_loop;
  }
...
/* seteq?#1594 */
static obj cxs_seteq_3F_231594(obj v1597_s1, obj v1596_s2)
{ 
    return (bool_from_obj(cxs_subsetq_3F_231598((v1597_s1), (v1596_s2))) ? (cxs_subsetq_3F_231598((v1596_s2), (v1597_s1))) : obj_from_bool(0));
}
...
case 0: /* load module */
    ...
    { static obj c[] = { obj_from_case(3) }; cx_curry_2Dexp_231422 = (obj)c; }
    { static obj c[] = { obj_from_case(6) }; cx_unionq_231461 = (obj)c; }
    { static obj c[] = { obj_from_case(8) }; cx_setdiffq_231479 = (obj)c; }
    { static obj c[] = { obj_from_case(10) }; cx_intersectionq_231496 = (obj)c; }
...
case 3: /* curry-exp#1422 k id ids rands */
    assert(rc == 5);
    r += 1; /* shift reg. wnd */
gs_curry_2Dexp_231422: /* k id ids rands */
...
case 10: /* intersectionq#1496 k s1 s2 */
    assert(rc == 4);
    r += 1; /* shift reg. wnd */
gs_intersectionq_231496: 
...
case 141: /* clo ek r */
  ...
  if (bool_from_obj(cxs_seteq_3F_231594((r[1]), (r[7])))) {
    r[0] = r[2];  
    pc = objptr_from_obj(r[0])[0];
    r[1] = r[4];  
